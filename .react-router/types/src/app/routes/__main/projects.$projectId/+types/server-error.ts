...
type Module = typeof import("../server-error.js")

type Info = GetInfo<{
  file: "routes/__main/projects.$projectId/server-error.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  id: "routes/__main";
  module: typeof import("../../../__main.js");
}, {
  id: "routes/__main/projects.$projectId";
  module: typeof import("../../projects.$projectId.js");
}, {
  id: "routes/__main/projects.$projectId/server-error";
  module: typeof import("../server-error.js");
}];
