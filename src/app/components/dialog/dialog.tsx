...
export const Overlay = twix(
  Dialog.Overlay,
  cx(
    "absolute left-0 top-0 z-50 box-border grid h-full w-full place-items-center overflow-y-auto px-4 py-4 sm:px-[40px] sm:py-[40px]",
...
export const Content = twix(
  Dialog.Content,
  cx(
    "relative z-50 w-full max-w-[1000px] rounded-md bg-elevation-surface px-4 py-4 text-font shadow-lg sm:w-4/5 sm:px-8 sm:py-6",
