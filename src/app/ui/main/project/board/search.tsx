  ...
  return (
    <div className="relative w-fit">
      <input
        ...
        className={cx(
          "h-[40px] w-[120px] rounded border-none bg-background-input py-2 text-font hover:bg-background-input-hovered",
      ...
      />
      <span className="absolute right-0 top-1/2 -translate-y-1/2 px-2 text-font">
        {renderIcon()}
      </span>
    </div>
  );
