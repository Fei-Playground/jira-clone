...
const ids1 = [
  ...
  "a2d88ad3-29b3-422c-8219-54bb66b26ff5",
  "c1278ad3-29b3-422c-8219-54bb66b26ff4",
];
const issuesMock1 = [todoIssuesMock1, inProgressIssuesMock1, qaIssuesMock1, doneIssuesMock1];

const ids2 = [
  "bbb348d5-ef02-447c-94f5-5fbf1ceeac07",
  "14055a19-1a79-4b16-90fb-811652e33128",
  "b3c55bd3-29b3-422c-8219-54bb66b26ff6",
  "aa102bcb-335c-4d82-8392-058f6172ebe8",
];
const issuesMock2 = [todoIssuesMock2, inProgressIssuesMock2, qaIssuesMock2, doneIssuesMock2];
