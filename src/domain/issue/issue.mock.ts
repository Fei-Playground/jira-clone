...
export const todoIssuesMock1: Issue[] = [
  {
    ...
    categoryType: "DONE",
    dueDate: new Date("2022-02-15").valueOf(),
    labels: [],
    linkedIssues: [],
    watchers: [userMock1],
    activityHistory: [],
...
export const inProgressIssuesMock1: Issue[] = [
  ...
  },
  {
    ...
    priority: priorityHigh,
    categoryType: "IN_PROGRESS",
    dueDate: new Date("2022-01-30").valueOf(),
    labels: [],
    linkedIssues: [],
...
export const doneIssuesMock1: Issue[] = [
  {
    ...
    categoryType: "DONE",
    dueDate: new Date("2022-01-20").valueOf(),
    labels: [],
    linkedIssues: [],
    watchers: [userMock1],
    activityHistory: [],
  ...
  },
  {
    ...
    priority: priorityMedium,
    categoryType: "DONE",
    dueDate: new Date("2022-01-25").valueOf(),
    labels: [],
    linkedIssues: [],
    watchers: [userMock1],
    activityHistory: [],
...
export const todoIssuesMock2: Issue[] = [
  {
    id: "e80a7d51-6e5f-4897-b0b6-b5d7b6c8cade",
    ...
    priority: priorityMedium,
    categoryType: "TODO",
    dueDate: new Date("2022-02-10").valueOf(),
    labels: [],
    linkedIssues: [],
    watchers: [userMock1, userMock2],
    activityHistory: [],
