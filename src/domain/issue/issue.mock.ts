...
export const todoIssuesMock1: Issue[] = [
  {
    ...
    categoryType: "DONE",
    startDate: new Date("2022-01-10").valueOf(),
    dueDate: new Date("2022-01-18").valueOf(),
    createdAt,
...
export const inProgressIssuesMock1: Issue[] = [
  {
    ...
    startDate: new Date("2022-01-18").valueOf(),
    dueDate: new Date("2022-01-28").valueOf(),
    createdAt,
    updatedAt: createdAt,
  },
  {
    ...
    priority: priorityHigh,
    categoryType: "IN_PROGRESS",
    startDate: new Date("2022-01-20").valueOf(),
    dueDate: new Date("2022-02-02").valueOf(),
    createdAt,
...
export const doneIssuesMock1: Issue[] = [
  {
    ...
    categoryType: "DONE",
    startDate: new Date("2022-01-05").valueOf(),
    dueDate: new Date("2022-01-12").valueOf(),
    createdAt,
  ...
  },
  {
    ...
    priority: priorityMedium,
    categoryType: "DONE",
    startDate: new Date("2022-01-08").valueOf(),
    dueDate: new Date("2022-01-15").valueOf(),
    createdAt,
...
export const todoIssuesMock2: Issue[] = [
  {
    ...
    priority: priorityMedium,
    categoryType: "TODO",
    startDate: new Date("2022-01-25").valueOf(),
    dueDate: new Date("2022-02-08").valueOf(),
    createdAt,
  ...
  },
  {
    ...
    priority: priorityLow,
    categoryType: "TODO",
    startDate: new Date("2022-02-01").valueOf(),
    dueDate: new Date("2022-02-14").valueOf(),
    createdAt,
...
export const inProgressIssuesMock2: Issue[] = [
  {
    ...
    priority: priorityHigh,
    categoryType: "IN_PROGRESS",
    startDate: new Date("2022-01-22").valueOf(),
    dueDate: new Date("2022-02-05").valueOf(),
    createdAt,
    updatedAt: createdAt,
  },
];
